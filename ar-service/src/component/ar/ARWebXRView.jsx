    ...
    <div className="fixed inset-0 z-[200] bg-black">
      ...
      <div className="absolute top-0 left-0 w-full p-4 flex justify-between items-center z-10">
        <div className="bg-black/50 text-white px-4 py-2 rounded-full text-sm backdrop-blur">
          {bedPosition ? "Chăn ga đã được đặt. Di chuyển xung quanh để xem." : "Quét mặt phẳng sàn/giường và chạm để đặt chăn ga"}
        </div>
        <button
          onClick={onClose}
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10">
        <button
          ...
          className="bg-white text-black px-6 py-3 rounded-full font-bold uppercase tracking-wider shadow-xl shadow-black/50"
        >
